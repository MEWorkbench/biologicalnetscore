...
public class EFLMotifs implements IMotifs, Serializable {

	private static final long serialVersionUID = 1L;
	protected String name;
	protected EFLMotif[] motifs;
	...
	public EFLMotifs(EFLMotif[] motifs, INode[] nodes, String name) {
		this.name = name;
		...
		this.motifs = new EFLMotif[sos.length];
		
		for(int i=0;i<sos.length;i++)
		{
			this.motifs[i] = (EFLMotif)sos[i].getNode();
		}
	...
	@Override
	public int[][] getStats() {
		return new int[][]{this.startOccurrences, this.endOccurrences, this.pathOccurrences};
	}

	@Override
	public String[] getStatsNames() {
		return new String[]{"Start","End","Path"};
	}
